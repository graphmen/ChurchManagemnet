...
import { X, Send, ClipboardList, TrendingUp, Users, Heart, CheckCircle2 } from 'lucide-react';
import { createClient } from '@supabase/supabase-js';

const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://hupqhiyxlghccdabqlrs.supabase.co';
const SUPABASE_KEY = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_Zx71cr2QdmE0Il7AAFCX4w_L3XalRVp';
